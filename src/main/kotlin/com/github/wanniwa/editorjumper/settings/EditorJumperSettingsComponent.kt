...
class EditorJumperSettingsComponent {
    ...
    init {
        ...
        val multiShortcutHintLabel = JBLabel("<html><em>${I18nUtils.message("settings.hint.multiEditorShortcuts")}</em></html>")
        ...
        val formBuilder = FormBuilder.createFormBuilder()
                ...
                .addComponent(multiShortcutHintLabel)
    ...
    fun getAntigravityPath(): String {
        return antigravityPathField.text
    }

    fun setAntigravityPath(path: String) {
